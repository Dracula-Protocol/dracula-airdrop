...
import Distributor from '../artifacts/MerkleDistributor.json'
import TestERC20 from '../artifacts/TestERC20.json'
  ...
  describe('#claim', () => {
    ...
    describe('two account tree', () => {
      ...
      it('gas', async () => {
        ...
        expect(receipt.gasUsed).to.eq(78936)
      })
    })
    describe('larger tree', () => {
      ...
      it('gas', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(81469)
      })
      ...
      it('gas second down about 15k', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(66449)
      })
    })
    ...
    describe('realistic size tree', () => {
      ...
      it('gas', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(92328)
      })
      it('gas deeper node', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(92264)
      })
